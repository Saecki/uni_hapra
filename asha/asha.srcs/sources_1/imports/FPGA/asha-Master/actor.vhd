...
signal current_m,next_m:state_typeM := Asha2;--current and next state declaration.
...
signal current_s,next_s: state_typeS := Init;  --current and next state declaration.
