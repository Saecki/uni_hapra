...
begin
    ...
    CoreModuleADCTranslation : component adc_translation
        port map (
            clka  => Clock,
            addra => ATMemAddr,
            douta => ATMemData
    ...
    -- errechnen kann.
    --
    Process (Clock) is -- ADC Linearisierung: Uebersetzt die Daten nichtlinearer Sensoren in ein lineares VerhÃ¤ltnis
    begin
    ...
    --
    Process (Clock) is -- ADC Wertholprozess: Adresse anlegen, warten, auslesen
    begin
